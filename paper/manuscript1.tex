...
\textbf{(C4)} We conduct an encoder-transfer probe in Detroit, Zurich, and Taipei, which successfully identifies a Western-centric data limitation (accuracy in Taipei drops to near chance). We use this to design a vital safeguard: ensuring a deployed robot rejects the map-prior in geographic regions where it knows it cannot be trusted
...
CLIP B/16      & $0.499\pm0.060$ & $0.544\pm0.068$ & $0.080\pm0.017$         & $0.239\pm0.025$ & $3.0\times$ &  65.0 \\
CLIP L/14      & $0.531\pm0.065$ & $0.595\pm0.064$ & $0.080\pm0.011$         & $0.230\pm0.022$ & $2.9\times$ &  92.4 \\
DINOv2-base    & $0.496\pm0.064$ & $0.614\pm0.069$ & $0.080\pm0.010$         & $0.238\pm0.024$ & $3.0\times$ &  64.8 \\
DINOv2-large   & $\mathbf{0.613\pm0.071}$ & $0.613\pm0.059$ & $0.075\pm0.013$ & $0.253\pm0.023$ & $3.4\times$ &  78.5 \\
SigLIP2-base   & $0.502\pm0.057$ & $0.596\pm0.060$ & $0.082\pm0.011$         & $\mathbf{0.228\pm0.020}$ & $2.8\times$ &  72.1 \\
SigLIP2-SO400M & $0.579\pm0.064$ & $0.555\pm0.064$ & $0.066\pm0.014$         & $0.256\pm0.022$ & $3.9\times$ & 110.0 \\
ViT-B/16-sup   & $0.482\pm0.073$ & $0.573\pm0.070$ & $0.083\pm0.015$         & $0.274\pm0.027$ & $3.3\times$ &  60.0 \\
\midrule
...
Qwen3-VL-8B   & --   & 0.576 & --   & 0.468 & -- & 6{,}182 \\
LLaVA-1.5-7B  & --   & 0.418 & --   & 0.423 & -- &   135 \\
Qwen2.5-VL-7B & --   & 0.412 & --   & 0.632 & -- &   185 \\
\bottomrule
\end{tabular}%
}
\end{table}
...
\textbf{Geographic and demographic coverage.} Taipei transfer is near chance ($+1.8$\,pp), making Western-centric data the headline limitation. Demographics beyond aid type were not collected, and aid classes conflate equipment geometry, motor power, and individual risk tolerance.

\textbf{Single routing city, offline evaluation.} Routing uses one Pittsburgh OSM snapshot; the ORS comparison is $n{=}50$ pairs and should be read as directional evidence. We have not run a live wheelchair-user study, evaluated transient obstructions or sensor noise, or tested batched/low-power deployment.
...
\caption{Trained probes vs.\ zero-shot VLMs on overall macro-F1. Dashed blue line = best probe (F1 $= 0.617$). Qwen3-VL-8B (F1 $= 0.576$) comes within $0.041$ F1 at $\sim 80\times$ higher latency and $6.2\times$ worse Brier.}
\label{fig:zeroshot}
\end{figure}
